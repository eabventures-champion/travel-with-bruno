...
<body x-data="bookingApp">
    ...
    <header id="header" :class="{ 'scrolled': window.scrollY > 50 || mobileMenuOpen }"
        ...
        <!-- Mobile Nav -->
        <div class="mobile-nav" x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-500"
            ...
            <div x-data="{ tourOpen: false }">
                <a @click="tourOpen = !tourOpen"
                    ...
                    Tour <i class="fas" :class="tourOpen ? 'fa-chevron-up' : 'fa-chevron-down'"
                        style="font-size: 1rem; opacity: 0.5;"></i>
                </a>
                <div x-show="tourOpen" x-cloak
                    style="padding-left: 20px; background: #f8fafc; border-radius: 15px; margin-bottom: 10px;">
                    <a href="{{ route('tourism.destinations') }}" @click="mobileMenuOpen = false"
                        style="font-size: 1.1rem; padding: 12px 0; border: none;">Destinations</a>
                    <a href="{{ route('tourism.group-tours') }}" @click="mobileMenuOpen = false"
                        style="font-size: 1.1rem; padding: 12px 0; border: none;">Organized</a>
                </div>
            </div>
