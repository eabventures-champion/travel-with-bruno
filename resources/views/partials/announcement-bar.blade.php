...
<div id="announcement-bar" class="announcement-bar" style="background: var(--accent); color: white; padding: 12px 20px; text-align: center; position: sticky; z-index: 998; box-shadow: 0 4px 15px rgba(245, 158, 11, 0.3); display: flex; align-items: center; justify-content: center; gap: 15px; overflow: hidden;">
    ...
    <span class="announcement-text" style="font-weight: 700; letter-spacing: 0.5px;">
...
<style>
    ...
    @media (max-width: 768px) {
        .announcement-bar { flex-direction: column; gap: 6px; padding: 8px 12px !important; }
        .announcement-text { font-size: 0.75rem; text-align: center; line-height: 1.3; }
        .pulse-btn { padding: 4px 12px !important; font-size: 0.68rem !important; }
    }
</style>
<script>
